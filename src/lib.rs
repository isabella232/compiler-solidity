...
pub fn target_machine(
    ...
    inkwell::targets::Target::from_name(compiler_common::vm::TARGET_NAME)?.create_target_machine(
        &inkwell::targets::TargetTriple::create(compiler_common::vm::TARGET_NAME),
        "",
        "",
        optimization_level,
