...
pub use self::solc::hashes::Hashes as SolcHashes;
pub use self::solc::input::settings::Settings as SolcInputSettings;
pub use self::solc::input::source::Source as SolcInputSource;
